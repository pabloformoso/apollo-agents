...
# Per-genre BPM ranges (for clamping auto-detected BPM) and default session
# themes. Both live in agent/genre_config.py — a dependency-free module — so
# agent/tools.py and the web render endpoint can read them without importing
# this file and dragging in librosa/moviepy. Re-exported here under their
# historic names; add new genres in genre_config.py, not here.
from agent.genre_config import (  # noqa: E402
    BPM_GENRE_RANGES,
    GENRE_THEMES,
)
