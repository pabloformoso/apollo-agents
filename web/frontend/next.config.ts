...
const nextConfig: NextConfig = {
  ...
  // Prod runs `next dev` (compose), so the dev-tools badge sat in the corner
  // of every page — including the fullscreen visuals and whatever OBS
  // captures. Build/runtime errors still raise the overlay; only the idle
  // badge goes.
  devIndicators: false,
