...
Theme-driven visual customization system that allows sessions to override default rendering settings (fonts, colors, particles, waveform, background) via the session.json theme block, with full backward compatibility.
