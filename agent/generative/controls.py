...
CC contract (map these in Surge — modwheel is CC 1 and needs no MIDI learn;
right-click a knob -> "Assign to MIDI CC" for the rest):
  CC 1  = energy / intensity  (modwheel)
...
# most-specific first. Both CCs ramp together — one word, one gesture.
INTENT_TARGETS: list[tuple[str, dict[int, float]]] = [
    ("darker", {CC_ENERGY: 0.25, CC_BRIGHTNESS: 0.15}),
    ("dark", {CC_ENERGY: 0.3, CC_BRIGHTNESS: 0.2}),
    ("brighter", {CC_BRIGHTNESS: 0.85}),
    ("bright", {CC_BRIGHTNESS: 0.8}),
    ("open", {CC_BRIGHTNESS: 0.85}),
    ("peak", {CC_ENERGY: 1.0, CC_BRIGHTNESS: 0.9}),
    ("build", {CC_ENERGY: 0.85, CC_BRIGHTNESS: 0.7}),
    ("lift", {CC_ENERGY: 0.8, CC_BRIGHTNESS: 0.7}),
    ("energy", {CC_ENERGY: 0.9}),
    ("calm", {CC_ENERGY: 0.3, CC_BRIGHTNESS: 0.35}),
    ("down", {CC_ENERGY: 0.35, CC_BRIGHTNESS: 0.3}),
    ("strip", {CC_ENERGY: 0.2}),
]

DEFAULT_LEVELS = {CC_ENERGY: 0.6, CC_BRIGHTNESS: 0.6}
